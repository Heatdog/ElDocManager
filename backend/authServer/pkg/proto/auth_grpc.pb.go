...
func (c *authServerClient) GetTokens(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenRespons, error) {
	out := new(TokenRespons)
	err := c.cc.Invoke(ctx, "/auth.AuthServer/GetTokens", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthServer_GetTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServerServer).GetTokens(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.AuthServer/GetTokens",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServerServer).GetTokens(ctx, req.(*TokenRequest))
	}
